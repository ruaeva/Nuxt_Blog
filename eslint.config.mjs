    ...
    // Your custom configs here
    {
        ...
        rules: {
         // '@typescript-eslint/no-unused-vars': 'off',         // 忽略未使用变量
            ...
            '@typescript-eslint/no-unsafe-assignment': 'off',   // 忽略不安全赋值
            '@typescript-eslint/no-unsafe-member-access': 'off', // 忽略不安全成员访问
            '@typescript-eslint/no-unsafe-call': 'off',         // 忽略不安全调用
            '@typescript-eslint/explicit-module-boundary-types': 'off', // 忽略模块边界类型
            '@typescript-eslint/ban-ts-comment': 'off'          // 允许 TS 注释（如 @ts-ignore）
        }
    }
])
